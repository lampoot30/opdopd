                        ...
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                <c:forEach var="d" items="${designations}">
                                    <tr>
                                        <td><c:out value="${d.designationName}"/></td>
                                        <td class="text-end">
                                            <button class="btn btn-sm btn-outline-primary" data-bs-toggle="modal" data-bs-target="#editModal" data-id="${d.designationId}" data-name="${d.designationName}"><i class="fas fa-edit"></i></button>
                                            <button class="btn btn-sm btn-outline-danger" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="${d.designationId}" data-name="${d.designationName}"><i class="fas fa-trash"></i></button>
                                        </td>
                                    </tr>
                                </c:forEach>
