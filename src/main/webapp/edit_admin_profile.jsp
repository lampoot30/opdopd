...
<head>
    <meta charset="UTF-8" />
    <title>Edit My Profile - Admin Portal</title>
    ...
    <style>
        ...
        .card-header { font-weight: 600; color: white; border-top-left-radius: 15px; border-top-right-radius: 15px; background-color: #0d6efd; }
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" class="form-control" id="dateOfBirth" name="dateOfBirth" value="${adminProfile.dateOfBirth}" required>
                                </div>
                                <div class="col-md-6 mb-3">
