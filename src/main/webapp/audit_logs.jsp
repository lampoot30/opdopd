...
<head>
    <meta charset="UTF-8" />
    <title>My Activity Logs - Super Admin</title>
    <!-- Bootstrap CSS -->
...
<div class="main-content">
    <div class="dashboard-header">
        <h1 class="h2 mb-1"><i class="fas fa-user-shield me-2"></i>My Activity Logs</h1>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover align-middle">
                    ...
                    <tbody>
                        <c:forEach var="log" items="${myLogs}">
                            <tr>
                                <td>
                                ...
                                <td>
                                    <span class="badge bg-primary">${log.userType}</span>
                                </td>
                            </tr>
                        </c:forEach>
                ...
                <nav aria-label="Page navigation" class="p-3">
                    <ul class="pagination justify-content-center">
                        <li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
                            <a class="page-link" href="<c:url value='/audit-logs?page=${currentPage - 1}'/>">Previous</a>
                        </li>
                        <c:forEach var="i" begin="1" end="${totalPages}">
                            <li class="page-item ${i == currentPage ? 'active' : ''}">
                                <a class="page-link" href="<c:url value='/audit-logs?page=${i}'/>">${i}</a>
                            </li>
                        </c:forEach>
                        <li class="page-item ${currentPage == totalPages ? 'disabled' : ''}">
                            <a class="page-link" href="<c:url value='/audit-logs?page=${currentPage + 1}'/>">Next</a>
                        </li>
                    </ul>
                </nav>
            </c:if>
