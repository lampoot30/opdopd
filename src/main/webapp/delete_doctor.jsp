...
<head>
    <meta charset="UTF-8" />
    <title>Delete Doctor Accounts - Admin Portal</title>
...
<div class="main-content">
    <div class="container-fluid">
        <h1 class="h2 mb-4"><i class="fas fa-user-md me-2"></i>Delete Doctor Accounts</h1>
        <div class="card mt-4">
            <div class="card-header">
                <h5 class="mb-0"><i class="fas fa-exclamation-triangle me-2"></i>Select a Doctor to Delete</h5>
            </div>
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            <%-- This part should be populated by a servlet fetching doctor data --%>
                            <c:forEach var="doctor" items="${doctorList}">
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal" data-user-id="${doctor.id}" data-user-name="${doctor.name}">
                            ...
                            <c:if test="${empty doctorList}">
                                <tr><td colspan="4" class="text-center text-muted p-4">No doctors found.</td></tr>
                            </c:if>
                        </tbody>
                    </table>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="<c:url value='/delete-doctor-account'/>" method="post" class="d-inline">
