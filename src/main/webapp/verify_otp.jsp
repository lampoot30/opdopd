...
<body>
    <div class="card p-4">
        <div class="text-center mb-4">
            ...
            <p class="text-muted">An OTP was sent to your number. Please enter the 6-digit code to confirm your changes.</p>
        </div>
        ...
        <form action="verify-otp-and-update" method="post">
            ...
            <button type="submit" class="btn btn-primary w-100">Verify & Update</button>
        </form>
            ...
            fetch('resend-otp', { method: 'POST' })
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        ...
                        // We need to update the session value on the server, but for the client-side timer to work
                        // on refresh, the server should have already set the new 'lastOtpTime' on the session.
                        // The AJAX call to 'resend-otp' handles this.
                    }
                })
                .catch(error => {
